<?php
namespace App\Http\Controllers\CallerId;
...
//                $ret = $this->_exec("mode " . $this->_windevice . " BAUD=" . $validBauds[$rate], $out);
                $ret = $this->_exec( exec("mode " . $this->_windevice . " BAUD=" . $validBauds[$rate]), $out);
            }
            else return false;
...
//            $ret = $this->_exec("mode " . $this->_windevice . " PARITY=" . $parity{0}, $out);
            ...
            $ret = $this->_exec( exec("mode " . $this->_windevice  ." PARITY=" . $parity{0}), $out);
        }
...
//            $ret = $this->_exec("mode " . $this->_windevice . " DATA=" . $int, $out);
            ...
            $ret = $this->_exec( exec("mode " . $this->_windevice ." DATA=" . $int), $out);
        }
...
//            $ret = $this->_exec("mode " . $this->_windevice . " STOP=" . $length, $out);
            $ret = $this->_exec( exec("mode " . $this->_windevice .  " STOP=" . $length), $out);
        }
...
//            $ret = $this->_exec("mode " . $this->_windevice . " " . $windowsModes[$mode], $out);
            ...
            $ret = $this->_exec( exec("mode " . $this->_windevice .  " " . $windowsModes[$mode]), $out);
