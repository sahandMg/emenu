                ...
                <div class="card" style="padding: 1%;">
                    ...
                    <div class="flex-row space-between" style="align-items: stretch;margin-bottom: 2%;">
                      ...
                      <div  class="flex-row" style="align-content: flex-end;flex-grow: 1;direction: ltr;">
                        <button style="margin-right: 4%;"  id="print@{{ order.id }}"   style="cursor: pointer;" @click="printBill(order.id)"><img height="20" width="20" src="{{(('images/printer.png'))}}"></button>
                        <button style="margin-right: 4%;"  id="cancel@{{ order.id }}"   style="cursor: pointer;" @click="cancel(order.id)"><img height="20" width="20" src="{{(('images/cancel.png'))}}"></button>
                      </div>
                    </div>
                    <!-- <br/> -->
